...
<div class="deznav">
    <div class="deznav-scroll">
        <ul class="metismenu" id="menu">
            ...
            {{-- Core HR – only if user has 'View HR Dashboard' permission --}}
            ...
            @canany(['View Users', 'manage-roles', 'manage-permissions'])
                <li>
            ...
            {{-- CMS: Blog / Categories --}}
            @canany(['View Posts', 'Create Posts', 'View Categories', 'Create Categories'])
                <li>
            ...
            {{-- Chat / Messenger – accessible to all authenticated users --}}
            <li>
            ...
            {{-- Account – always visible (user's own account) --}}
            <li>
