<div>
    ...
    {{-- ═══ Badge styles for the message icon ═══ --}}
    <style>
        .bell-link {
            position: relative;
            display: inline-flex;
            ...
            <nav class="navbar navbar-expand">
                <div class="collapse navbar-collapse justify-content-between">
                    ...
                    <ul class="navbar-nav header-right">
                            ...
                            <div class="dropdown-menu dropdown-menu-end" wire:ignore>
                                <div id="DZ_W_TimeLine02" class="widget-timeline dz-scroll style-1 p-3 height370">
                                    <ul class="timeline">
                                        ...
                                        <li>
                                            <div class="timeline-badge info"></div><a class="timeline-panel text-muted"
                                                href="javascript:void(0);"><span>20 minutes ago</span>
                                        ...
                                        <li>
                                            <div class="timeline-badge dark"></div><a class="timeline-panel text-muted"
                                                href="javascript:void(0);"><span>20 minutes ago</span>
                                                <h6 class="mb-0">Mashable, a news website and blog, goes live.</h6>
                                            </a>
                                        </li>
                        ...
                        <!-- Dropdown 2 – Notification bell (no badge) -->
                        <li class="nav-item dropdown notification_dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end" wire:ignore>
                                <!-- ... static notification content (unchanged) ... -->
                            </div>
                        </li>
                            ...
                            <div class="dropdown header-profile2">
                                <a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown"
                                    ...
                                    <div class="header-info2 d-flex align-items-center">
                                        <div class="header-media"><img src="images/tab/1.jpg" alt=""></div>
                                    ...
                                    <div class="card border-0 mb-0">
                                        <div class="card-header py-2">
                                            <div class="products">
                                                ...
                                                <div>
                                                    <h6>Thomas Fleming</h6><span>Web Designer</span>
                                                </div>
                                            </div>
                                        </div>
