            ...
            <div class="text-center space-y-8">
                ...
                <div class="relative">
                    ...
                    <div class="absolute inset-0 flex items-center justify-center">
                        <div class="w-24 h-24 border-4 border-green-200 border-t-green-500 rounded-full animate-spin"></div>
                    </div>
                </div>
                        ...
                        <div class="flex items-start">
                            ...
                            <div class="text-left">
                                ...
                                <p class="text-sm text-green-700 mt-1">
                                    We've sent a password reset link to <strong class="font-semibold">{{ $email }}</strong>
                                </p>
                            </div>
                        </div>
                    </div>
