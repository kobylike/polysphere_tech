...
<head>
    ...
    <title>Your account has been created — {{ $companyName }}</title>
                ...
                <table role="presentation" width="100%" style="max-width:600px;">
                    ...
                    <tr>
                        <td style="background:linear-gradient(120deg,#0F172A 0%,#1E293B 45%,#312E81 100%);
                            ...
                            <p
                                style="margin:10px 0 0; color:rgba(255,255,255,0.6); font-size:13px; letter-spacing:.02em;">
                    ...
                    <tr>
                        <td style="background:#ffffff; padding:36px 40px;">
                            ...
                            <p style="margin:0 0 20px; font-size:15px; color:#475569; line-height:1.6;">
                                @if($createdByName)
                                    <strong>{{ $createdByName }}</strong> has created an account for you on
                                @else
                                ...
                                <tr>
                                    <td style="padding:14px 18px;">
                                        <p
                                            style="margin:0 0 3px; font-size:11px; text-transform:uppercase; letter-spacing:.1em; color:#94A3B8; font-weight:600;">
                                            Role</p>
                                        <p style="margin:0; font-size:14px; color:#475569;">{{ $roleName }}</p>
                                    </td>
                                </tr>
                            </table>
                            ...
                            {{-- Password card --}}
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0"
                                style="background:#FFFBEB; border:1px solid #FDE68A; border-radius:10px; margin-bottom:28px; overflow:hidden;">
                                <tr>
                                    <td style="padding:16px 18px;">
                                        <p
                                            style="margin:0 0 6px; font-size:11px; text-transform:uppercase; letter-spacing:.1em; color:#B45309; font-weight:700;">
                            ...
                            <table role="presentation" cellpadding="0" cellspacing="0" style="margin:0 auto;">
                                <tr>
                                    <td style="border-radius:50px; overflow:hidden;">
                                        <a href="{{ $loginUrl }}"
                                            style="display:inline-block; padding:14px 40px; background:linear-gradient(120deg,#312E81,#4338CA); color:#ffffff; text-decoration:none; font-size:16px; font-weight:700; border-radius:50px; letter-spacing:-.1px;">
                                            Sign In Now
                                        </a>
                                    </td>
                                </tr>
