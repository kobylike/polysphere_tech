                ...
                <table role="presentation" width="100%" style="max-width:560px;">
                            ...
                            <table role="presentation" align="center" cellpadding="0" cellspacing="0">
                                <tr>
                                    ...
                                    <td style="vertical-align:middle;">
                                        <span
                                            style="font-family:'Segoe UI',Arial,sans-serif; font-weight:700; font-size:19px; color:#fff; letter-spacing:-.4px;">
                                            Polysphere Tech
                                        </span>
                                    </td>
                                </tr>
                    ...
                    <tr>
                        <td style="background:#ffffff; padding: 44px 40px 36px; text-align:center;">
                            ...
                            {{-- Check mark icon --}}
                            <div
                                style="width:56px; height:56px; margin:0 auto 22px; border-radius:50%;
                            ...
                            <h1
                                style="margin:0 0 12px; font-size:21px; font-weight:700; color:#0f172a; letter-spacing:-.3px;">
                                Thanks for reaching out, {{ $recipientName }}!
                            </h1>

                            <p
                                style="margin:0 0 24px; font-size:15px; line-height:1.7; color:#475569; max-width:420px; margin-left:auto; margin-right:auto;">
