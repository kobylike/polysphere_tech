                    ...
                    <tr>
                        <td style="background:#ffffff; padding: 36px 40px;">
                            ...
                            <p style="margin:0 0 20px; font-size:15px; color:#475569; line-height:1.6;">
                                ...
                                You will be given the role of <strong>{{ $roleName }}</strong>.
                            </p>
                            ...
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    <td style="padding:14px 18px;">
                                        <p style="margin:0 0 3px; font-size:11px; text-transform:uppercase; letter-spacing:.1em;
                                                  color:#94A3B8; font-weight:600;">Expiry</p>
                            ...
                            <table role="presentation" cellpadding="0" cellspacing="0" style="margin:0 auto;">
                                <tr>
                                    <td style="border-radius:50px; overflow:hidden;">
                                        <a href="{{ $registrationUrl }}" style="display:inline-block; padding:14px 40px;
