...
<body>
    <div class="error-card">
        ...
        <p>
            ...
            <br>Our team has been notified and is working on a fix.
        </p>
        ...
        @if(isset($exception) && $exception->getMessage() && config('app.debug'))
            <div
                style="margin-top:2rem; padding:1rem; background:#fef2f2; border-radius:0.75rem; text-align:left; font-size:0.8rem; color:#991b1b; border:1px solid #fecaca;">
